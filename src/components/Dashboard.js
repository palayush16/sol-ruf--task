  ...
  return (
    <>
        ...
        <Card>
            ...
            {currentUser && <h3><strong>Email:</strong> {currentUser.email}</h3>}
            {/* <h4>UserName</h4>
            ...
            <input type="file" className="w-100 dflex just mt-2 text-align-center"onChange={handleChange}/>
            
            <img src={photoURL} alt="Avatar" className="text-center w-100 "/>
            <Button disabled={loading || !photo} variant="secondary" className="mt-1 w-100" onClick={handleClick}>Upload Photo</Button>
